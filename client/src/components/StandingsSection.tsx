/*
  ...
  Standings table with highlighted row for our team
*/
...
export default function StandingsSection() {
  return (
    <section id="standings" className="py-20 bg-[oklch(0.15_0.008_265)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Column legend */}
        <div className="mt-4 flex flex-wrap gap-4 text-xs text-[oklch(0.45_0.01_265)]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="mt-6 bg-[oklch(0.17_0.008_265)] border border-[oklch(0.28_0.008_265)] rounded-sm p-4">
